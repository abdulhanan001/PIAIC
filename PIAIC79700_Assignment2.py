...
def function3():
    ...
    #print(a)
    x = a[([a%5==0] and [a%7==0])] # wrtie your code here
    return x
...
def function11():
    ...
    #ans = np.array([arr if np.mod(arr)!= 0]) # write your code here
    return ans
...
def function12():
    ...
    arr = np.array([1, 2, 3])
    ans = np.append(np.repeat(arr,3),np.tile(arr,3))# write your code here
...
def function13():
    ...
    ans =  np.where(arr > 5,arr) & np.where(arr < 9 ,arr)# write your code here
...
def function14():
    ...
    ans = np.split(arr,[3])# write your code here
...
def function15():
    ...
    ans =  np.sort(arr,2,axis=1)# write your code here
...
def function17():
    ...
    return  np.where((arr/3 == 0 & arr/5 == 0))# Write Your Code HERE
...
def function18():
    ...
    x =  piaic.where(students in range(100))# Write you code Here
    return x
